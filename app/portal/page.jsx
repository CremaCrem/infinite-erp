          ...
          <div className='h-[500px] w-[500px] bg-gradient-to-tr from-DarkBlue to-LightBlue flex justify-center items-center rounded-l-[20px]'>
            ...
            <div className='flex flex-col justify-start m-10 w-[350px]'>
              ...
              <div className='flex flex-col items-center gap-y-10 mt-11'>
                ...
                <Link href="/supplies" className='h-[50px] rounded-[24px] w-[250px] font-Lato text-LightBlue text-center text-2xl pt-2 shadow-xl hover:bg-Goldy hover:text-white hover:h-[60px] hover:w-[270px] hover:pt-3 hover:rounded-[30px] transition-all  duration-300'>Supply</Link>
              </div>
            </div>
        </div>
    </div>
